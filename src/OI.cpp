...
OI::OI() {
    ...
    SmartDashboard::PutData("B Haut", new BSetAvant(0.1));
    SmartDashboard::PutData("B Load", new BSetAvant(BouffeurAvant::Position::Load));
    SmartDashboard::PutData("B bas", new BSetAvant(BouffeurAvant::Position::Max));
    SmartDashboard::PutData("C bas", new CSet(CSet::Position::Min));
    SmartDashboard::PutData("C load", new CSet(CSet::Position::Shoot));
    ...
    button1->WhenPressed(new CSet(CSet::Position::Shoot));
    //button2->WhenPressed(new CSet(CSet::Position::Min, true));
    button2->WhenPressed(new BSetAvant(BouffeurAvant::Position::Load));
