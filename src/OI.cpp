...
/*
    ...
    SmartDashboard::PutData("Tourner 2", new Tourner(2));
    ...
    SmartDashboard::PutData("Avancer -1m", new Avancer(-1));
    SmartDashboard::PutData("Tourner 90", new Tourner(80));
    SmartDashboard::PutData("Tourner -90", new Tourner(-80));
    SmartDashboard::PutData("Tourner 180", new Tourner(170));
    SmartDashboard::PutData("Tourner 45", new Tourner(45));
...
*/
    ...
    button2->WhenPressed(new Viser(false));
